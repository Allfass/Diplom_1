...
class TestBurger():
    ...
    def test_set_buns_may_return_bun_variable(self, burger):
        bun = Mock()
        bun.name = "name"
        burger.set_buns(bun)
        assert burger.bun.name == "name"

    def test_add_ingredient_append_value_to_list(self, burger):
        ingredient_mock = Mock()
        ingredient_mock.name = "name"
        burger.add_ingredient(ingredient_mock)
        assert burger.ingredients[0].name == "name"

    def test_add_ingredient_several_times_append_values_to_list(self, burger):
        ingredient_mock = Mock()
    ...
    def test_remove_ingredient_return_empty_list(self, burger):
        ingredient_mock = Mock()
        ingredient_mock.name = "name"
        burger.add_ingredient(ingredient_mock)
    ...
    def test_move_ingredient_swap_two_elements_and_check_their_position(self, burger):
        ingredient_mock = Mock()
        second_ingredient_mock = Mock()
        ingredient_mock.name = "name"
        second_ingredient_mock.name = "second_name"
    ...
    def test_get_price_return_value(self, burger, bun_price, ingredient_price, final_value):
        bun_mock = Mock()
        ingredient_mock = Mock()
    ...
    def test_get_receipt_return_receipt(self, burger):
        bun_mock = Mock()
        ingredient_mock = Mock()
